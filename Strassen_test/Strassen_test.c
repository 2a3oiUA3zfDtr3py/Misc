...
int mul_mat(RealNumber **data_a,RealNumber **data_x,RealNumber **data_b)
{
    int i,j,k,ret_code;
    ret_code = 0;
...
int strassen(RealNumber **data_a,RealNumber **data_b,RealNumber **data_c,int x,int y,int z,RealNumber ***temp)
{
    ...
    while(1)
    {
        ...
        if(i==0)
        {
            ...
            {
                case 0:
                    strassen_mov_s2c(data_a,temp[8],l,m,0,0);
                    strassen_add_s2c(data_a,temp[8],l,m,l,m);
                    strassen_mov_s2c(data_b,temp[9],m,n,0,0);
                    strassen_add_s2c(data_b,temp[9],m,n,m,n);
                    break;
                case 1:
                    strassen_mov_s2c(data_a,temp[8],l,m,l,0);
                    strassen_add_s2c(data_a,temp[8],l,m,l,m);
                    strassen_mov_s2c(data_b,temp[9],m,n,0,0);
                    break;
                case 2:
                    strassen_mov_s2c(data_a,temp[8],l,m,0,0);
                    strassen_mov_s2c(data_b,temp[9],m,n,0,n);
                    strassen_sub_s2c(data_b,temp[9],m,n,m,n);
                    break;
                case 3:
                    strassen_mov_s2c(data_a,temp[8],l,m,l,m);
                    strassen_mov_s2c(data_b,temp[9],m,n,m,0);
                    strassen_sub_s2c(data_b,temp[9],m,n,0,0);
                    break;
                case 4:
                    strassen_mov_s2c(data_a,temp[8],l,m,0,0);
                    strassen_add_s2c(data_a,temp[8],l,m,0,m);
                    strassen_mov_s2c(data_b,temp[9],m,n,m,n);
                    break;
                case 5:
                    strassen_mov_s2c(data_a,temp[8],l,m,l,0);
                    strassen_sub_s2c(data_a,temp[8],l,m,0,0);
                    strassen_mov_s2c(data_b,temp[9],m,n,0,0);
                    strassen_add_s2c(data_b,temp[9],m,n,0,n);
                    break;
                case 6:
                    strassen_mov_s2c(data_a,temp[8],l,m,0,m);
                    strassen_sub_s2c(data_a,temp[8],l,m,l,m);
                    strassen_mov_s2c(data_b,temp[9],m,n,m,0);
                    strassen_add_s2c(data_b,temp[9],m,n,m,n);
                    break;
                case 7:
                    strassen_mov_c2c(temp[0],temp[7],l,n);
                    strassen_add_c2c(temp[3],temp[7],l,n);
                    strassen_sub_c2c(temp[4],temp[7],l,n);
                    strassen_add_c2c(temp[6],temp[7],l,n);
                    strassen_mov_c2s(temp[7],data_c,l,n,0,0);
                    strassen_mov_c2c(temp[2],temp[7],l,n);
                    strassen_add_c2c(temp[4],temp[7],l,n);
                    strassen_mov_c2s(temp[7],data_c,l,n,0,n);
                    strassen_mov_c2c(temp[1],temp[7],l,n);
                    strassen_add_c2c(temp[3],temp[7],l,n);
                    strassen_mov_c2s(temp[7],data_c,l,n,l,0);
                    strassen_mov_c2c(temp[0],temp[7],l,n);
                    strassen_add_c2c(temp[2],temp[7],l,n);
                    strassen_sub_c2c(temp[1],temp[7],l,n);
                    strassen_add_c2c(temp[5],temp[7],l,n);
                    strassen_mov_c2s(temp[7],data_c,l,n,l,n);
                    break;
            }
        }
        else
        ...
        else if(i == strassen_factor - 1 && j < 7)
        {
...
int main(int argc,char **argv)
{
    ...
    temp = (RealNumber ***)malloc(10*strassen_factor*sizeof(RealNumber **));
    if(temp == NULL)
    {
        ret_code = -1;
        goto error11;
    ...
    temp[0] = (RealNumber **)malloc(i*sizeof(RealNumber *));
    if(temp[0] == NULL)
    {
        ret_code = -1;
        goto error12;
    ...
    temp[0][0] = (RealNumber *)malloc(i*sizeof(RealNumber));
    if(temp[0][0] == NULL)
    {
        ret_code = -1;
        goto error13;
    ...
    for(j=0;j<strassen_factor;j++)
    {
        ...
        {
            temp[0][i+1] = temp[0][i] + (matX_col/l);
            i++;
        }
        for(k=0;k<(matA_row/l);k++)
        {
            temp[0][i+1] = temp[0][i] + (matA_col/l);
            i++;
        }
